...
ALTER TABLE search_result ADD CONSTRAINT search_result_search_request_id_fk FOREIGN KEY (search_reauest_id) REFERENCES search_request;
...
ALTER TABLE search_request ADD CONSTRAINT search_request_area_id_fk FOREIGN KEY (area) REFERENCES area;
...
INSERT INTO public.area (id,country,name,type,code,zip,ext_code) VALUES (1,'RUS','Moscow','REG','77','101000','1');
